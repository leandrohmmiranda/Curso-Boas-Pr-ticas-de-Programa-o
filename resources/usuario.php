                ...
                <form class="form-horizontal form-material" action="<?= BASE_URL; ?>/cad-usuario" method="POST" autocomplete="off">
                    <div class="form-group mb-4">
                        ...
                        <div class="col-md-12 border-bottom p-0">
                            <input type="text" placeholder="Johnathan Doe" name="nome" id="nome" class="form-control p-0 border-0" value="<?= $old['nome']; ?>">
                        </div>
                    </div>
                    <div class="form-group mb-4">
                        <label for="email" class="col-md-12 p-0">E-mail</label>
                        <div class="col-md-12 border-bottom p-0">
                            <input type="email" placeholder="johnathan@admin.com" class="form-control p-0 border-0" name="email" id="email" value="<?= $old['email']; ?>">
                        </div>
                    </div>
                    <div class="form-group mb-4">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="col-md-12 border-bottom p-0" for="telefone">
                            <input type="text" placeholder="(99) 99999-9999" name="telefone" id="telefone" value="<?= $old['telefone']; ?>" class="form-control p-0 border-0">
                        </div>
                    </div>
