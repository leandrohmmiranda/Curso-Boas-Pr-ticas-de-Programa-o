                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-md-12 border-bottom p-0">
                                <input type="text" placeholder="Descrição da conta" name="descricao" id="descricao" class="form-control p-0 border-0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-md-12 border-bottom p-0">
                                <input type="date" class="form-control p-0 border-0" name="dataVencimento" id="dataVencimento">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
