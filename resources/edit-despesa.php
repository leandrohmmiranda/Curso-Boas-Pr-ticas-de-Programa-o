                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-md-12 border-bottom p-0">
                                <input type="text" placeholder="Descrição da conta" name="descricao" id="descricao" class="form-control p-0 border-0" value="<?= $despesa['descricao']; ?>">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-md-12 border-bottom p-0">
                                <input type="date" class="form-control p-0 border-0" name="dataVencimento" id="dataVencimento" value="<?= $despesa['vencimento']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-4">
                            ...
                            <div class="col-md-12 border-bottom p-0">
                                <input type="text" placeholder="R$ 0,00" name="valor" class="form-control p-0 border-0" id="valor" value="<?= $despesa['valor']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
